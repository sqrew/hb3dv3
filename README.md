...
Dynamic Lighting System: A unique atmospheric lighting system using positive and negative light sources that affect the skybox. Located in src/graphics/lighting.rs with integration throughout the rendering pipeline.
